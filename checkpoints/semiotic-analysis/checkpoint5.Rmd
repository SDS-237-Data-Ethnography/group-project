---
title: 'SDS 237: Final Project Checkpoint 5 - Semiotic Analysis'
author:
  - Fill
  - Fill
  - Fill
...
Find a file for your dataset online (preferably in .csv format) and add it to the `datasets/` folder in this repo. 

```{r}
#Most groups will need the read.csv() function to load your data. If you're unable to download your dataset as a .csv and don't know how to import your data, please send me a DM asap.
#As a refresher, here is a code template for you to follow:
#df <- read.csv("datasets/file_name.csv")
